 ...
 * @returns {Promise<PlaywrightBrowser>} A Playwright Browser instance.
 */
 ...
 * @returns {Promise<{browser: PlaywrightBrowser | null, message: string | null}>} Object containing the browser instance or an error message.
 */
 ...
 * @param {PlaywrightBrowser} args.browser - The Playwright browser instance.
 ...
 * @param {boolean|undefined} headless - Whether to run the browser in headless mode.
