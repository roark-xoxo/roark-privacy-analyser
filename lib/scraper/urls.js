...
/**
 * Adds special internal links based on features and updates the data object.
 * @param {object} params - Parameters including features and data.
 * @param {ScraperArgsFeaturesType} params.features - The features for scraping.
 * @param {CollectedData} params.data - The collected data.
 */
export function addExtendedSitePaths({ features, data }) {
  if (!features.extendedSitePaths) return;
