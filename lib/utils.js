 ...
 * @param {string} data - The parameters to log. Can be of any type.
 * @param {string} filename - The parameters to log. Can be of any type.
 */
export function writeResultsToFile(data, filename) {
  try {
    const logDir = "./.cache/results";
