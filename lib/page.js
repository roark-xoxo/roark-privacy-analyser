 ...
 * If "domain" is set, it ignores the subdomain in the comparison. If "subdomain" is set, which it defaults to, going from example.com to subdomain.emxaple.com marks it as an redirect.
